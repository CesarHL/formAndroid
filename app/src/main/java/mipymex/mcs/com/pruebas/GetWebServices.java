            ...
            case "fotos":
                try {
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK) {
                        ...
                        SharedPreferences.Editor editor = context.getSharedPreferences(Login.PREFS_NAME, 0).edit();
                        editor.putInt("array_size", fotos.length());
                        String cat_pa_id;
                        ...
                        for (int i = 0; i < fotos.length(); i++) {
                            ...
                            editor.putString("cat_pa_id" + i,cat_pa_id);
                            editor.putString("cat_pa_descripcion" + i, cat_pa_descripcion);
